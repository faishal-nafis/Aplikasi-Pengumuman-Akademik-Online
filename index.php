...
<body>
    ...
    <footer class="py-5 mt-auto text-center">
        <div class="container">
            ...
            <div class="mb-4">
                <a href="https://www.instagram.com/polibatamofficial/" target="_blank" class="text-white-50 mx-2"><i class="bi bi-instagram"></i></a>
                <a href="https://www.polibatam.ac.id/" class="text-white-50 mx-2" target="_blank"><i class="bi bi-globe"></i></a>
                <a href="https://id.linkedin.com/school/politeknik-negeri-batam/" target="_blank" class="text-white-50 mx-2"><i class="bi bi-linkedin"></i></a>
            </div>
